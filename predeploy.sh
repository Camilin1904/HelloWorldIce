plink.exe -ssh swarch@xhgrid1 -pw swarch -m mkdir.sh  
...
plink.exe -ssh swarch@xhgrid12 -pw swarch -m mkdir.sh  
plink.exe -ssh swarch@xhgrid13 -pw swarch -m mkdir.sh  
plink.exe -ssh swarch@xhgrid14 -pw swarch -m mkdir.sh  
plink.exe -ssh swarch@xhgrid15 -pw swarch -m mkdir.sh  
plink.exe -ssh swarch@xhgrid16 -pw swarch -m mkdir.sh  
plink.exe -ssh swarch@xhgrid17 -pw swarch -m mkdir.sh  
plink.exe -ssh swarch@xhgrid18 -pw swarch -m mkdir.sh  
plink.exe -ssh swarch@xhgrid19 -pw swarch -m mkdir.sh  
plink.exe -ssh swarch@xhgrid20 -pw swarch -m mkdir.sh    
